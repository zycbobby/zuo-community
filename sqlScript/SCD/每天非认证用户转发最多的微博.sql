...
(
select rc.*
from SinaUnverified.dbo.status_rt_cmt_unverified_otweet as rc
inner join SinaUnverified.dbo.status as s on rc.status_id=s.status_id
where rc.rtCount>10000
) as t
inner join SinaUnverified.dbo.status as s
