function network_integration(adj_relation, adj_content)
% noted that adj_content should be binary here
    adj=(adj_relation+adj_content)./2;
    com_list=eig_solve(adj,'community_combined_network.txt');
    ...
    fname=strcat('community.list');
    fid=fopen(fname,'w');
    fprintf(fid, '{"modularity1":%f, "modularity2":%f,"product":%f,"sim_criterion":%f}\n',q1,q2,q1*q2,0.53);
