function pmm_solve_with_similarity_weighted_l1l2l()
...
for k=2:8
    for l1=2:2:12
        for l2=2:2:12
            for l=2:10
                [q1,q2,com_list]=pmm_solve_ret(k,l1,l2,l);
                fname=strcat('community_',num2str(k),'_',num2str(l1),'_',num2str(l2),'_',num2str(l),'.list');
                fid=fopen(fname,'w');
                fprintf(fid, '{"modularity1":%f, "modularity2":%f,"product":%f,"k":%d,"l1":%d, "l2":%d, "sim_criterion":%f,"l":%d}\n',q1,q2,q1*q2,k,l1,l2,sim_criterion,l);
...
function [Q1,Q2,com_list]=pmm_solve_ret(k,l1,l2,l)
